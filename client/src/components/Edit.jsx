                ...
                <h5>Submit edits below</h5>
                    ...
                    <div className="row spaced">
                        <div className='col-12'>
                            <label className = "labelFont" htmlFor="title">Song Title</label>
                    ...
                    <div className="row spaced">
                        <div className='col-12'>
                            <label className = "labelFont" htmlFor="artist">Artist</label>
                    ...
                    <div className="row spaced">
                        <div className='col-12'>
                            <label className = "labelFont" htmlFor="image">Image URL</label>
                    ...
                    <div className="row spaced">
                        <div className='col-12'>
                            <label className = "labelFont" htmlFor="title">How does this song make you feel?</label>
